...
# ggplot themes
tree_legend  <- scale_shape_manual(values = 1:6, guide = guide_legend(reverse = TRUE))
...
```{r fig.height = 5, echo = FALSE, fig.width = 8, out.width = "95%", fig.align = "center", fig.cap = "Performance of tensoRphylo (orange) against diversitree (blue) and castor (green) as a function of tree size and number of states."}
# read the results
