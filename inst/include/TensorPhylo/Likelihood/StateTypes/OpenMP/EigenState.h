...
#ifndef LIKELIHOOD_STATETYPES_OPENMP_EIGENSTATE_H_
#define LIKELIHOOD_STATETYPES_OPENMP_EIGENSTATE_H_
...
private:
	...
	//mutable EigenMatrixAlloc* stateProb;
	...
	friend void swap ( EigenState< CPT > &p1, EigenState< CPT > &p2 );
...
template< Likelihood::Conditions::conditionalProbability_t conditionalProbType >
struct vector_space_norm_inf< Likelihood::StateType::OpenMP::EigenState< conditionalProbType > >
{
    typedef double result_type;
    double operator()( const Likelihood::StateType::OpenMP::EigenState< conditionalProbType > &state ) const {
...
template< Likelihood::Conditions::conditionalProbability_t conditionalProbType >
struct is_resizeable< Likelihood::StateType::OpenMP::EigenState< conditionalProbType > > { // declare resizeability
    typedef boost::true_type type;
    const static bool value = type::value;
};

template< Likelihood::Conditions::conditionalProbability_t conditionalProbType >
struct same_size_impl< Likelihood::StateType::OpenMP::EigenState<conditionalProbType> , Likelihood::StateType::OpenMP::EigenState<conditionalProbType> > { // define how to check size
    static bool same_size( const Likelihood::StateType::OpenMP::EigenState< conditionalProbType > &state1,
                          				  const Likelihood::StateType::OpenMP::EigenState< conditionalProbType > &state2 )
    {
...
template< Likelihood::Conditions::conditionalProbability_t conditionalProbType >
struct resize_impl< Likelihood::StateType::OpenMP::EigenState<conditionalProbType> , Likelihood::StateType::OpenMP::EigenState<conditionalProbType> > { // define how to resize
    static void resize( Likelihood::StateType::OpenMP::EigenState< conditionalProbType > &state1,
                        const Likelihood::StateType::OpenMP::EigenState< conditionalProbType > &state2 )
    {
...
#endif /* LIKELIHOOD_STATETYPES_OPENMP_EIGENSTATE_H_ */
