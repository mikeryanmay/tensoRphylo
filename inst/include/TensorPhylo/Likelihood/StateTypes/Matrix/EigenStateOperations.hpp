/*
 * EigenStateOperations.hpp
 *
 *  Created on: Apr 15, 2020
 *      Author: meyerx
 */

#ifndef LIKELIHOOD_STATETYPES_MATRIX_EIGENSTATEOPERATIONS_HPP_
#define LIKELIHOOD_STATETYPES_MATRIX_EIGENSTATEOPERATIONS_HPP_
...
struct EigenStateOperations
{
    ...
    struct scale
    {
        ...
        void operator()( EigenState &t1 ) const
        {
            t1 *= m_alpha1;
        }
    ...
    struct scale_sum1
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 ) const
        {
    ...
    struct scale_sum2
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3) const
        {
        	t1.initMult(m_alpha1, t2);
        	t1.addMult(m_alpha2, t3);
        }
    ...
    struct scale_sum3
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 ) const
        {
			t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
        }
    ...
    struct scale_sum4
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5) const
        {

			t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
			t1.addMult(m_alpha4, t5);
        }
    ...
    struct scale_sum5
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6) const
        {
			t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
			t1.addMult(m_alpha4, t5);
			t1.addMult(m_alpha5, t6);
        }
    ...
    struct scale_sum6
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 ,const EigenState &t7) const
        {
			t1.initMult(m_alpha1, t2);
        	t1.addMult(m_alpha2, t3);
        	t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum7
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 ) const
        {
			t1.initMult(m_alpha1, t2);
        	t1.addMult(m_alpha2, t3);
        	t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum8
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 ) const
        {
        	t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum9
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum10
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 , const EigenState &t11 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum11
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 , const EigenState &t11 , const EigenState &t12 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum12
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 , const EigenState &t11 , const EigenState &t12 , const EigenState &t13 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum13
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 , const EigenState &t11 , const EigenState &t12 , const EigenState &t13 , const EigenState &t14 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum14
    {
        ...
        void operator()( EigenState &t1 , const EigenState &t2 , const EigenState &t3 , const EigenState &t4 , const EigenState &t5 , const EigenState &t6 , const EigenState &t7 , const EigenState &t8 , const EigenState &t9 , const EigenState &t10 , const EigenState &t11 , const EigenState &t12 , const EigenState &t13 , const EigenState &t14 , const EigenState &t15 ) const
        {
            t1.initMult(m_alpha1, t2);
			t1.addMult(m_alpha2, t3);
			t1.addMult(m_alpha3, t4);
    ...
    struct scale_sum_swap2
    {
        ...
        void operator()( EigenState &t1 , EigenState &t2 , const EigenState &t3) const
        {
        	assert(false && "Not yet implemented.");
            const EigenState tmp( t1 );
    ...
    struct rel_error
    {
        ...
        void operator()( EigenState &t3 , const EigenState &t1 , const EigenState &t2 ) const
        {
            //using std::abs;
...
#endif /* LIKELIHOOD_STATETYPES_MATRIX_EIGENSTATEOPERATIONS_HPP_ */
